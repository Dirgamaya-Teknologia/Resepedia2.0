...
//        Double porsi_data = resep_list.get(position).getPorsi();
//        viewHolder.setPorsiText("Untuk " + porsi_data.toString()+ " Porsi");
...
//        public void setPorsiText(String porsiText){
//
//            porsiView = mView.findViewById(R.id.txt_porsi_resep);
//            porsiView.setText(porsiText);
//
//        }
